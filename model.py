...
if __name__ == '__main__':
    sketch, color, weights = load(os.path.expanduser
                                 ('~/Desktop/hdf5/clear/database_train.h5'))
                                 # ('~/Desktop/DeepLearningImplementations/DFI/data/processed/lfw_224_data.h5'))
    train(batch_size=64, n_batch_per_epoch=1, nb_epoch=10000, sketch=sketch, color=color,
          weights=weights, tag='1-1-64batch-64-22', save_weight=0, img_dim=[64,64,1])
